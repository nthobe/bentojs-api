...
Bento.Log = {
  ...
  /**
   * Logs a new debug event on the terminal.
   * @param {String} value A string or object
   */
  debug(value) {
  ...
  /**
   * Logs a new info event on the terminal.
   * @param {String} value A string or object
   */
  info(value) {
  ...
  /**
   * Logs a new warn event on the terminal.
   * @param {String} value A string or object
   */
  warn(value) {
  ...
  /**
   * Logs a new event on the terminal and emits a 'log:event' event.
  ...
  event(payload) {
    ...
    console.log('\n' + prettify.render(changeCase.objectKeys('toUpper', payload), {
      keysColor   : 'magenta',
      stringColor : 'white'
    }, 4) + '\n');
  },
